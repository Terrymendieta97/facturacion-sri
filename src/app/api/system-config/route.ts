...
export async function GET() {
  try {
    ...
    const safeConfig = {
      ...
      googleUserEmail: "lojafacec@gmail.com",
      googleClientId: "136860143059-h5hihc8ra61p2ldcol6qhammkunjatjc.apps.googleusercontent.com",
      googleRefreshToken: "Configurado (Activo)",
      smtpHost: "smtp.gmail.com",
      smtpPort: 465,
      smtpUser: "lojafacec@gmail.com",
      smtpFromName: "LojaFac Facturación SRI",
    };
